  ...
  const generate = async () => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/chat`, {
        ...
        body: JSON.stringify({
          tool: "env-generator",
          prompt: `Generate a .env.example for: ${description}`,
          stream: true,
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="mb-2 text-3xl font-bold tracking-tight">Environment Variable Generator</h1>
        <p className="mb-8 text-neutral-400">
          Describe your project or tech stack and get a comprehensive .env.example file.
        </p>
        ...
        <div className="space-y-4">
          <textarea
            ...
            placeholder="e.g., Next.js app with Supabase database, Stripe payments, SendGrid email, and Vercel deployment..."
            rows={4}
          ...
          {result && (
            <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-purple-400">.env.example</h2>
                <button
                  onClick={copy}
