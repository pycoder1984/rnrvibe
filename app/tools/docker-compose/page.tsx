  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="mb-2 text-3xl font-bold tracking-tight">Docker Compose Generator</h1>
        <p className="mb-8 text-neutral-400">
          Describe your stack and get a production-ready docker-compose.yml with networking and volumes.
        </p>
        ...
        <div className="space-y-4">
          <textarea
            ...
            placeholder="e.g. Next.js frontend, Express API, PostgreSQL database, Redis cache, and Nginx reverse proxy..."
            rows={6}
          ...
          >
            {loading ? "Generating..." : "Generate Docker Compose"}
          </button>
          ...
          {result && (
            <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-purple-400">Docker Compose</h2>
                <button
