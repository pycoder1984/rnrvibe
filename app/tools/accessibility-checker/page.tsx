    ...
    try {
      const res = await fetch(`${getApiBase()}/api/chat`, {
        ...
        body: JSON.stringify({
          ...
          prompt: `Check this code for accessibility issues:\n\n\`\`\`\n${code}\n\`\`\``,
          stream: true,
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="mb-2 text-3xl font-bold tracking-tight">Accessibility Checker</h1>
        <p className="mb-8 text-neutral-400">
          Paste HTML or JSX code and get a WCAG 2.1 AA accessibility audit with fixes.
        </p>
        ...
        <div className="space-y-4">
          ...
          {result && (
            <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-6">
              <h2 className="mb-4 text-lg font-semibold text-purple-400">Accessibility Report</h2>
