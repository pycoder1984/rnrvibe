...
export default function ShareButtons({ title, slug, type }: { title: string; slug: string; type: "blog" | "guides" }) {
  const [copied, setCopied] = useState(false);
  const url = `https://www.rnrvibe.com/${type}/${slug}`;
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <a
        ...
        className="p-2 rounded-lg bg-neutral-900 border border-neutral-800 text-neutral-400 hover:text-white hover:border-neutral-600 transition-all"
